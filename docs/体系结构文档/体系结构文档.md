...
| ------------------------------------- | ---------------------- |
| **服务名**                            | **服务**               |
| hotelController.retrieveAllHotels     | 获取酒店列表           |
| hotelController.retrieveHotelDetail   | 获取特定酒店信息       |
| orderController.reserveHotel          | 预定酒店               |
| couponController.getOrderMatchCoupons | 将优惠信息添加到订单中 |
...
| couponController.getHotelAllCoupons        | 查看酒店所有优惠信息 |
| couponController.addHotelTargetMoneyCoupon | 添加酒店优惠信息     |
...
| orderConrtroller.retrieveUserOrders | 查看订单     |
