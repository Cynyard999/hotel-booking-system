...
|                             接口                             | 服务调用方 | 服务提供方 |
| :----------------------------------------------------------: | ---------- | ---------- |
| adminController<br>hotelController<br>couponController<br>orderController<br>userController | 展示层     | 控制层     |
| adminService<br>hotelService<br>roomService<br>couponService<br>orderService<br>accountService | 控制层     | 业务逻辑层 |
| adminMapper<br>hotelMapper<br>roomMapper<br>couponMapper<br>orderMapper<br>accountMapper | 业务逻辑层 | 数据层     |
...
数据库中包含coupon表，hotel表，orderList表，room表以及user表