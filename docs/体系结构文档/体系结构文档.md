...
| HotelMapper.updateHotelInfo(Integer id,String name,String address,String bizRegion,String hotelStar,String description,String phoneNum) | 根据id更新对应酒店的名称、地址、商圈、星级、描述、电话号码信息 |
